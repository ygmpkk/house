#ifndef __FPTOOLS_CONFIG_H__
#define __FPTOOLS_CONFIG_H__
...
/* mk/config.h.  Generated by configure.  */
...
/* Define to 1 if the HaskellSupport.framework is installed (Mac OS X only).
   */
...
/* Define to 1 if gcc supports -mno-omit-leaf-frame-pointer. */
...
/* Define to 1 if you have the <pascal.h> header file. */
/* #undef HAVE_PASCAL_H */

/* Define to 1 if you have the `PBHSetVolSync' function. */
...
/* Define to 1 if readline/readline.h and readline/history.h exist. */
/* #undef HAVE_READLINE_HEADERS */

/* Define to 1 if readline plus any additional libs needed for it exist. */
...
/* Define to 1 if you have the sigpoll() function. */
/* #undef HAVE_SIGPOLL */
...
/* Define to 1 if you have the `vadvise' function. */
/* #undef HAVE_VADVISE */
...
/* Define to 1 if you want to include .NET interop support. */
