...
{-# NOINLINE writeForeignObjOffAddr# #-}
writeForeignObjOffAddr# a1 a2 a3 a4 = (GHC.Prim.writeForeignObjOffAddr#) a1 a2 a3 a4
...
{-# NOINLINE mkForeignObj# #-}
mkForeignObj# a1 a2 = (GHC.Prim.mkForeignObj#) a1 a2
{-# NOINLINE writeForeignObj# #-}
writeForeignObj# a1 a2 a3 = (GHC.Prim.writeForeignObj#) a1 a2 a3
{-# NOINLINE foreignObjToAddr# #-}
foreignObjToAddr# a1 = (GHC.Prim.foreignObjToAddr#) a1
{-# NOINLINE touch# #-}
touch# a1 a2 = (GHC.Prim.touch#) a1 a2
{-# NOINLINE eqForeignObj# #-}
eqForeignObj# a1 a2 = (GHC.Prim.eqForeignObj#) a1 a2
{-# NOINLINE indexCharOffForeignObj# #-}
indexCharOffForeignObj# a1 a2 = (GHC.Prim.indexCharOffForeignObj#) a1 a2
{-# NOINLINE indexWideCharOffForeignObj# #-}
indexWideCharOffForeignObj# a1 a2 = (GHC.Prim.indexWideCharOffForeignObj#) a1 a2
{-# NOINLINE indexIntOffForeignObj# #-}
indexIntOffForeignObj# a1 a2 = (GHC.Prim.indexIntOffForeignObj#) a1 a2
{-# NOINLINE indexWordOffForeignObj# #-}
indexWordOffForeignObj# a1 a2 = (GHC.Prim.indexWordOffForeignObj#) a1 a2
{-# NOINLINE indexAddrOffForeignObj# #-}
indexAddrOffForeignObj# a1 a2 = (GHC.Prim.indexAddrOffForeignObj#) a1 a2
{-# NOINLINE indexFloatOffForeignObj# #-}
indexFloatOffForeignObj# a1 a2 = (GHC.Prim.indexFloatOffForeignObj#) a1 a2
{-# NOINLINE indexDoubleOffForeignObj# #-}
indexDoubleOffForeignObj# a1 a2 = (GHC.Prim.indexDoubleOffForeignObj#) a1 a2
{-# NOINLINE indexStablePtrOffForeignObj# #-}
indexStablePtrOffForeignObj# a1 a2 = (GHC.Prim.indexStablePtrOffForeignObj#) a1 a2
{-# NOINLINE indexInt8OffForeignObj# #-}
indexInt8OffForeignObj# a1 a2 = (GHC.Prim.indexInt8OffForeignObj#) a1 a2
{-# NOINLINE indexInt16OffForeignObj# #-}
indexInt16OffForeignObj# a1 a2 = (GHC.Prim.indexInt16OffForeignObj#) a1 a2
{-# NOINLINE indexInt32OffForeignObj# #-}
indexInt32OffForeignObj# a1 a2 = (GHC.Prim.indexInt32OffForeignObj#) a1 a2
{-# NOINLINE indexInt64OffForeignObj# #-}
indexInt64OffForeignObj# a1 a2 = (GHC.Prim.indexInt64OffForeignObj#) a1 a2
{-# NOINLINE indexWord8OffForeignObj# #-}
indexWord8OffForeignObj# a1 a2 = (GHC.Prim.indexWord8OffForeignObj#) a1 a2
{-# NOINLINE indexWord16OffForeignObj# #-}
indexWord16OffForeignObj# a1 a2 = (GHC.Prim.indexWord16OffForeignObj#) a1 a2
{-# NOINLINE indexWord32OffForeignObj# #-}
indexWord32OffForeignObj# a1 a2 = (GHC.Prim.indexWord32OffForeignObj#) a1 a2
{-# NOINLINE indexWord64OffForeignObj# #-}
indexWord64OffForeignObj# a1 a2 = (GHC.Prim.indexWord64OffForeignObj#) a1 a2
{-# NOINLINE newMutVar# #-}
...
{-# NOINLINE newBCO# #-}
newBCO# a1 a2 a3 a4 a5 a6 a7 = (GHC.Prim.newBCO#) a1 a2 a3 a4 a5 a6 a7
{-# NOINLINE inb# #-}
inb# a1 a2 = (GHC.Prim.inb#) a1 a2
{-# NOINLINE outb# #-}
outb# a1 a2 a3 = (GHC.Prim.outb#) a1 a2 a3
{-# NOINLINE registerForIRQ# #-}
registerForIRQ# a1 a2 = (GHC.Prim.registerForIRQ#) a1 a2
{-# NOINLINE waitNextInterrupt# #-}
waitNextInterrupt# a1 a2 = (GHC.Prim.waitNextInterrupt#) a1 a2
