module ControlResize(resizeControls) where
...
import	CommonDef
import	WindowHandle
import	StdControlAttribute(isControlResize, getControlResizeFun,
...
import	WindowAccess(getWItemCompoundInfo, getWItemEditInfo, getWItemSliderInfo, 
		     getCompoundContentRect,
		     getWindowHMargins, getWindowVMargins, getWindowItemSpaces)
import	WindowClipState(forceValidWindowClipState, invalidateCompoundClipState)
...
import	OSWindow(osMinWindowSize, osMinCompoundSize, osScrollbarsAreVisible)
