...
extern void WinInvalidateWindow (int hwnd);
extern void WinInvalidateRect (int hwnd, int left, int top, int right, int bottom);
extern void WinValidateRect (int hwnd, int left, int top, int right, int bottom);
extern void WinValidateRgn (int hwnd, HRGN rgn);
