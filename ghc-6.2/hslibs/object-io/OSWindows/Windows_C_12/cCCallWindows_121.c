...
void WinInvalidateWindow (int hwnd)
{
	InvalidateRect ((HWND) hwnd, NULL, FALSE);
}

void WinInvalidateRect (int hwnd, int left, int top, int right, int bottom)
{
	RECT rect;
...
void WinValidateRect (int hwnd, int left, int top, int right, int bottom)
{
	RECT rect;
...
void WinValidateRgn (int hwnd, HRGN rgn)
{
